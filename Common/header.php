...
<body>
    <nav class="navbar navbar-expand-lg fixed-top px-4">
        <div class="d-flex align-items-center">
            ...
            <a class="navbar-brand fw-bold fs-5 text-white me-3" href="#" style="letter-spacing: 1px;">MITS Assessment Portal</a>
        </div>
        <a class="navbar-brand position-absolute top-50 start-50 translate-middle" href="#">
            <img src="../Images/MITS Logo.png" alt="MITS Logo" height="50" class="me-2">
        </a>
