                            ...
                            <div class="row mt-3 align-items-end">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="Department" class="form-select" required onchange="this.form.submit();">
                                        ...
                                        <?php
                                            $dquery = "SELECT * FROM department ORDER BY Dept_Name";
                                            $run = mysqli_query($con, $dquery);
                                            while ($row = mysqli_fetch_assoc($run)) {
                                                $selected = (isset($_POST['Department']) && $_POST['Department'] == $row['Dept_ID']) ? 'selected' : '';
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="Course_ID" class="form-select" required onchange="this.form.submit();">
                                        ...
                                        <?php
                                            ...
                                            $Dept_ID  = isset($_POST['Department']) ? mysqli_real_escape_string($con, $_POST['Department']) : '';
